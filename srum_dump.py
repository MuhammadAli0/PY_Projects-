...
def lookup_sid(sid):
    ...
    known_sids = {'S-1-5-32-545': ' Users', 'S-1-5-32-544': ' Administrators', 'S-1-5-32-547': ' Power Users',
                  'S-1-5-32-546': ' Guests', 'S-1-5-32-569': ' BUILTIN\\Cryptographic Operators',
                  'S-1-16-16384': ' System Mandatory Level ', 'S-1-5-32-551': ' Backup Operators',
                  'S-1-16-8192': ' Medium Mandatory Level ', 'S-1-5-80': ' NT Service ',
                  'S-1-5-32-548': ' Account Operators', 'S-1-5-32-561': ' BUILTIN\\Terminal Server License Servers',
                  'S-1-5-64-14': ' SChannel Authentication ', 'S-1-5-32-562': ' BUILTIN\\Distributed COM Users',
                  'S-1-5-64-21': ' Digest Authentication ', 'S-1-5-19': ' NT Authority', 'S-1-3-0': ' Creator Owner',
                  'S-1-5-80-0': ' All Services ', 'S-1-5-20': ' NT Authority', 'S-1-5-18': ' Local System',
                  'S-1-5-32-552': ' Replicators', 'S-1-5-32-579': ' BUILTIN\\Access Control Assistance Operators',
                  'S-1-16-4096': ' Low Mandatory Level ', 'S-1-16-12288': ' High Mandatory Level ',
                  'S-1-2-0': ' Local ', 'S-1-16-0': ' Untrusted Mandatory Level ', 'S-1-5-3': ' Batch',
                  'S-1-5-2': ' Network', 'S-1-5-1': ' Dialup', 'S-1-5-7': ' Anonymous', 'S-1-5-6': ' Service',
                  'S-1-5-4': ' Interactive', 'S-1-5-9': ' Enterprise Domain Controllers', 'S-1-5-8': ' Proxy',
                  'S-1-5-32-550': ' Print Operators', 'S-1-0-0': ' Nobody',
                  'S-1-5-32-559': ' BUILTIN\\Performance Log Users', 'S-1-5-32-578': ' BUILTIN\\Hyper-V Administrators',
                  'S-1-5-32-549': ' Server Operators', 'S-1-2-1': ' Console Logon ', 'S-1-3-1': ' Creator Group',
                  ...
                  'S-1-16-28672': ' Secure Process Mandatory Level ', 'S-1-5-11': ' Authenticated Users',
                  'S-1-1-0': ' Everyone', 'S-1-5-32-555': ' BUILTIN\\Remote Desktop Users',
                  'S-1-16-8448': ' Medium Plus Mandatory Level ', 'S-1-5-17': ' This Organization ',
                  ...
                  'S-1-5-10': ' Principal Self', 'S-1-3': ' Creator Authority', 'S-1-2': ' Local Authority',
                  'S-1-1': ' World Authority', 'S-1-0': ' Null Authority',
                  'S-1-5-32-574': ' BUILTIN\\Certificate Service DCOM Access ', 'S-1-5': ' NT Authority',
                  'S-1-4': ' Non-unique Authority', 'S-1-5-32-560': ' BUILTIN\\Windows Authorization Access Group',
                            ...
                            for eachinterface in int_keys.subkeys():
                                if len(eachinterface.subkeys()) == 0:
                                    ...
                                    for eachprofile in eachinterface.subkey("Profiles").subkeys():
                                        profileid = \
                                            [x.value() for x in eachprofile.values() if x.name() == "ProfileIndex"][0]
                                                        ...
                                                        try:
                                                            ...
                                                            if rec_entry == None:
                                                                ...
                                                                if rec_entry['IdType'] == 0:
                                                                    proc_blob = 'None' if not rec_entry[
                                                                        'IdBlob'] else unicode(
                                                                    ...
                                                                    user_blob = 'None' if not rec_entry[
                                                                        'IdBlob'] else BinarySIDtoStringSID(
                                                                        rec_entry['IdBlob'].decode("hex"))
                                                                ...
                                                                def abort(error_code):
                                                                    if interactive_mode:
                                                                        ...
                                                                        def format_output(val, eachformat, eachstyle):
                                                                            ...
                                                                            new_cell = WriteOnlyCell(xls_sheet,
                                                                                                     value="init")
                                                                            ...
                                                                            if val == None:
                                                                                ...
                                                                                val = id_table.get(val,
                                                                                                   "No match in srum lookup table for %s" % (
                                                                                                       val))
                                                                                    ...
                                                                                    if type(val) == int:
                                                                                        ...
                                                                                        try:
                                                                                            ...
                                                                                            new_cell.comment = Comment(
                                                                                                "Warning: Unable to convert value %s to binary." % (
                                                                                                    val), "srum_dump")
                                                                                            elif eachformat.lower() == "interface_id" and options.reghive:
                                                                                            val = interface_table.get(
                                                                                                str(val), "")
                                                                                        ...
                                                                                        def rotating_list(somelist):
                                                                                            while True:
                                                                                                for x in somelist:
                                                                                                    ...
                                                                                                    ads = rotating_list(
                                                                                                        [
                                                                                                            "Mark Baggett and Don Williams wrote the first working copy of this program in less than 1 day. Coding in Python is easy.   Check out SANS Automating Infosec with Python SEC573 to learn to write program like this on your own.",
                                                                                                    ...
                                                                                                    def lookup_luid(
                                                                                                        ...
                                                                                                        inttype = \
                                                                                                            struct.unpack(
                                                                                                                ...
                                                                                                                format(
                                                                                                                    ...
                                                                                                                    "hex"))[
                                                                                                                0]
                                                                                                        return LUID_interface_types.get(
                                                                                                            str(
                                                                                                                inttype),
                                                                                                        ...
                                                                                                        parser.add_argument(
                                                                                                            "--XLSX_OUTFILE",
                                                                                                            "-o",
                                                                                                            default="SRUM_DUMP_OUTPUT.xlsx",
                                                                                                            help="Full path to the XLS file that will be created.")
                                                                                                        parser.add_argument(
                                                                                                            "--XLSX_TEMPLATE",
                                                                                                            "-t",
                                                                                                            help="The Excel Template that specifies what data to extract from the srum database. You can create templates with ese_template.py.")
                                                                                                        parser.add_argument(
                                                                                                            "--REG_HIVE",
                                                                                                            "-r",
                                                                                                            dest="reghive",
                                                                                                        ...
                                                                                                        parser.add_argument(
                                                                                                            "--quiet",
                                                                                                            "-q",
                                                                                                            help="Supress unneeded output messages.",
                                                                                                            action="store_true")
                                                                                                        ...
                                                                                                        if not options.SRUM_INFILE:
                                                                                                            ...
                                                                                                            options.SRUM_INFILE = raw_input(
                                                                                                                r"What is the path to the SRUDB.DAT file? (Ex: \image-mount-point\Windows\system32\sru\srudb.dat) : ")
                                                                                                            options.XLSX_OUTFILE = raw_input(
                                                                                                                r"What is my output file name (Press enter for the default SRUM_DUMP_OUTPUT.xlsx) (Ex: \users\me\Desktop\resultx.xlsx) : ")
                                                                                                            options.XLSX_TEMPLATE = raw_input(
                                                                                                                "What XLS Template should I use? (Press enter for the default SRUM_TEMPLATE.XLSX) : ")
                                                                                                            options.reghive = raw_input(
                                                                                                                "What is the full path of the SOFTWARE registry hive? Usually \image-mount-point\Windows\System32\config\SOFTWARE (or press enter to skip Network resolution) : ")
                                                                                                                ...
                                                                                                                if not options.XLSX_OUTFILE:
                                                                                                                    ...
                                                                                                                    if not os.path.exists(
                                                                                                                        ...
                                                                                                                        if not os.path.exists(
                                                                                                                            ...
                                                                                                                            if options.reghive and not os.path.exists(
                                                                                                                                    options.reghive):
                                                                                                                                ...
                                                                                                                                if options.reghive:
                                                                                                                                    interface_table = load_interfaces(
                                                                                                                                        options.reghive)
                                                                                                                                    ...
                                                                                                                                    try:
                                                                                                                                        ...
                                                                                                                                        try:
                                                                                                                                            template_wb = openpyxl.load_workbook(
                                                                                                                                                filename=options.XLSX_TEMPLATE)
                                                                                                                                            except Exception as e:
                                                                                                                                            ...
                                                                                                                                            for each_sheet in sheets:
                                                                                                                                                ...
                                                                                                                                                if ese_template_table == "#XLS_CONSTANTS#":
                                                                                                                                                    ...
                                                                                                                                                    for row_num in range(
                                                                                                                                                            1,
                                                                                                                                                                    template_sheet.max_row + 1):
                                                                                                                                                        for col_num in range(
                                                                                                                                                                1,
                                                                                                                                                                        template_sheet.max_column + 1):
                                                                                                                                                            try:
                                                                                                                                                                xls_sheet.cell(
                                                                                                                                                                    row=row_num,
                                                                                                                                                                    column=col_num).value = template_sheet.cell(
                                                                                                                                                                    row=row_num,
                                                                                                                                                                ...
                                                                                                                                                                for eachcolumn in range(
                                                                                                                                                                        1,
                                                                                                                                                                                template_sheet.max_column + 1):
                                                                                                                                                                    field_name = template_sheet.cell(
                                                                                                                                                                        row=2,
                                                                                                                                                                        column=eachcolumn).value
                                                                                                                                                                    if field_name == None:
                                                                                                                                                                        break
                                                                                                                                                                        field_style = template_sheet.cell(
                                                                                                                                                                            row=2,
                                                                                                                                                                            column=eachcolumn)
                                                                                                                                                                        format_cmd = template_sheet.cell(
                                                                                                                                                                            row=3,
                                                                                                                                                                            column=eachcolumn).value
                                                                                                                                                                        ese_template_formats.append(
                                                                                                                                                                            format_cmd)
                                                                                                                                                                        ese_template_styles.append(
                                                                                                                                                                            field_style)
                                                                                                                                                                        ese_template_fields.append(
                                                                                                                                                                            field_name.strip())
                                                                                                                                                                        # Now open the specified table in the ESE database for this sheet
                                                                                                                                                                        ese_table = ese_db.openTable(
                                                                                                                                                                            ese_template_table)
                                                                                                                                                                            ...
                                                                                                                                                                            if not options.quiet:
                                                                                                                                                                                try:
                                                                                                                                                                                    ...
                                                                                                                                                                                    for eachcolumn in range(
                                                                                                                                                                                            1,
                                                                                                                                                                                                    len(
                                                                                                                                                                                                        ese_template_fields) + 1):
                                                                                                                                                                                        cell_value = template_sheet.cell(
                                                                                                                                                                                            row=4,
                                                                                                                                                                                            column=eachcolumn).value
                                                                                                                                                                                        cell_style = template_sheet.cell(
                                                                                                                                                                                            row=4,
                                                                                                                                                                                            column=eachcolumn).style
                                                                                                                                                                                        new_cell = WriteOnlyCell(
                                                                                                                                                                                            xls_sheet,
                                                                                                                                                                                            value=cell_value)
                                                                                                                                                                                        ...
                                                                                                                                                                                        while True:
                                                                                                                                                                                            try:
                                                                                                                                                                                                ...
                                                                                                                                                                                                if ese_row == None:
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    xls_row = []
                                                                                                                                                                                                    row_num += 1
                                                                                                                                                                                                    for eachcolumn, eachformat, eachstyle in zip(
                                                                                                                                                                                                            ese_template_fields,
                                                                                                                                                                                                            ese_template_formats,
                                                                                                                                                                                                            ese_template_styles):
                                                                                                                                                                                                        if eachcolumn == "#XLS_COLUMN#":
                                                                                                                                                                                                            val = eachformat.replace(
                                                                                                                                                                                                                "#ROW_NUM#",
                                                                                                                                                                                                                str(
                                                                                                                                                                                                                    row_num))
                                                                                                                                                                                                            val = WriteOnlyCell(
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            if val == "UNABLETORETRIEVECOLUMN":
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                firstsheet = target_wb.get_sheet_by_name(
                                                                                                                                                                                                                    "Sheet")
                                                                                                                                                                                                                target_wb.remove_sheet(
                                                                                                                                                                                                                    firstsheet)
                                                                                                                                                                                                                try:
                                                                                                                                                                                                                    target_wb.save(
                                                                                                                                                                                                                        options.XLSX_OUTFILE)
                                                                                                                                                                                                                    except Exception as e:
